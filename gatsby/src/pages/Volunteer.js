...
const VolunteerPage = () => (
  <Layout fullMenu>
    <article id="main">
      <header>
        <h2>Volunteer ❤️</h2>
        <p>Join our cat-tastic team of volunteers making a difference in the lives of cats</p>
      </header>
      <section className="wrapper style5">
        <div className="inner">
          <h3>Volunteering</h3>
          <p>
            Long Beach Felines heavily relies on volunteers to support its efforts to help as many cats as possible. If you are an animal lover, and would like to contribute to a good cause, Long Beach Felines offers several opportunities to volunteer.          </p>
          <p>
